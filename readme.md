...
![Software](https://skillicons.dev/icons?i=docker,github,pycharm,visualstudio,unity,vscode)

![Databases](https://skillicons.dev/icons?i=mongodb,mysql,prisma,supabase,sequalize)

![Packages and Tools](https://skillicons.dev/icons?i=discordjs,dotnet,git,gradle,nginx,nodejs,npm,pnpm,react,regex,selenium,tailwind,vite)
